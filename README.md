...
2. 下载 `x-bilingual-reader-webstore-v0.6.2.zip`。
...
1. 从 Releases 下载 `bilingual-web-extension-skill-v0.6.2.zip`。
...
这个 Skill 不能通过 `chrome://extensions/` 加载；浏览器插件应下载 `x-bilingual-reader-webstore-v0.6.2.zip`。
